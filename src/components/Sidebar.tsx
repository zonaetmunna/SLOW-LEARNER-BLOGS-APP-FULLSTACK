import { Bookmark, History, Link, List, MessageSquare, User, Users } from 'lucide-react';
...
const Sidebar = () => {
	return (
		<div className='w-64 h-screen bg-gray-100 text-gray-700  border-r border-gray-200 fixed top-16'>
			...
			{/* Squads */}
			<div className='p-4 border-b border-gray-300'>
				<p className='uppercase text-sm font-semibold text-gray-500 mb-3'>Squads</p>
				<ul>
					<li className='flex items-center hover:bg-gray-200 p-2 rounded-lg transition ease-in-out duration-200'>
						<Users className='h-6 w-6 mr-4 text-gray-600' />
			...
			{/* Discover */}
			<div className='p-4 border-b border-gray-300'>
				<p className='uppercase text-sm font-semibold text-gray-500 mb-3'>Discover</p>
				<ul>
					<li className='flex items-center hover:bg-gray-200 p-2 rounded-lg transition ease-in-out duration-200'>
			...
			{/* Activity */}
			<div className='p-4'>
				<p className='uppercase text-sm font-semibold text-gray-500 mb-3'>Activity</p>
				<ul>
					<li className='flex items-center hover:bg-gray-200 p-2 rounded-lg transition ease-in-out duration-200'>
						<Link className='h-6 w-6 mr-4 text-gray-600' />
